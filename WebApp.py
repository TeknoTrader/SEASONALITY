...
with st.sidebar:
    background_input = st.color_input("Background color:", value= "#000000")
    text_input = st.color_input("Inserisci il tuo testo", value = "#fff")
...
def main():
    ...
    MesiComplessivi = []
    Months_to_consider = []
    NomiMesi2 = ["01-Jan", "02-Feb", "03-Mar", "04-Apr", "05-May", "06-JuN", "07-JuL", "08-Aug", "09-Sept", "10-Oct",
                 "11-Nov",
